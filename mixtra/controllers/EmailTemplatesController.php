...
class EmailTemplatesController extends \mixtra\controllers\MITController
{
    public function init()
    {
        $this->table = "mit_email_templates";
        $this->primary_key = "id";
        ...
        $this->form[] = ["label" => "Slug", "type" => "text", "name" => "slug", "required" => true, 'validation' => 'required|unique:mit_email_templates,slug'];
