...
class MITBooster
{
    public static function get_date_range($mode = 'month', $index = 0, $start = null, $end = null)
    {
    ...
    public static function get_date_ranges($mode)
    {
        if ($mode == 'month') {
            $i = 11;
        }
        ...
        while ($i >= 0) {
            $date_ranges[] = self::get_date_range($mode, $i);
            $i--;
        }
