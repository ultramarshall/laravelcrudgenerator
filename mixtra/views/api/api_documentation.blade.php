...
@section('content')
    ...
    <ul class="nav nav-tabs"  role="tablist">
        <li class="nav-item">
            <a class="nav-link active" href="{{ MITBooster::mainpath() }}" role="tab"><span class="hidden-sm-up"><i class="fa fa-file"></i></span> <span class="hidden-xs-down">API Documentation</span></a> 
        </li>
        <li class="nav-item">
            ...
            @push('bottom')
                ...
                <script>
                    ...
                    function deleteApi(id) {
                        var url = "{{url(config('mixtra.ADMIN_PATH').'/api_generator/delete-api')}}/" + id;
                        swal({
                            title: "Are you sure?",
            ...
            <table class='table table-striped table-api table-bordered'>
                ...
                <tr class='info'>
                    ...
                    <th>API Name
                      ...
                      <a class='btn btn-xs btn-warning' target="_blank" href='{{MITBooster::mainpath("download-postman")}}'>Export For POSTMAN <sup>Beta</sup></a>
                    </span> -->
                    </th>
                </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <sup>
                                ...
                                &nbsp; <a title='Edit This API' href="{{url(config('mixtra.ADMIN_PATH').'/api_generator/edit-api').'/'.$api->id}}"><i
