...
@section('content')
    ...
    <ul class="nav nav-tabs"  role="tablist">
        <li class="nav-item">
            <a class="nav-link" href="{{ MITBooster::mainpath() }}" role="tab"><span class="hidden-sm-up"><i class="fa fa-file"></i></span> <span class="hidden-xs-down">API Documentation</span></a> 
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ MITBooster::mainpath('screet-key') }}" role="tab"><span class="hidden-sm-up"><i class="fa fa-key"></i></span> <span class="hidden-xs-down">API Secret Key</span></a> 
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ MITBooster::mainpath('generator') }}" role="tab"><span class="hidden-sm-up"><i class="fa fa-cog"></i></span> <span class="hidden-xs-down">API Generator</span></a> 
        </li>
    </ul>
        ...
        <div class='card-body'>
            @push('bottom')
                <script>
                    ...
                    function load_response() {
                        ...
                        no_params = 0;
                        $.get('{{url(config("mixtra.ADMIN_PATH"))."/api_generator/column-table"}}/' + t + '/' + type, function (resp) {
            ...
            <form method='post' action='{{ route("ApiCustomControllerPostSaveApiCustom")}}'>
                ...
                <div class='row'>
                    <div class='col-sm-8'>
                        <div class='form-group'>
                            ...
                            <input type='text' class='form-control' value='{{$row->name}}' required name='name' id='input-name'/>
                        </div>
                    </div>
                    ...
                    <div class='col-sm-4'>
                        <div class='form-group'>
                            <label>Table</label>
                            <select id='combo_table_name' name='table_name' required class='form-control'>
                ...
                <div class='row'>
                    <div class='col-sm-8'>
                        <div class='form-group'>
                            ...
                            <div class='input-group'>
                                <span class="input-group-addon" id="basic-addon1" style="background:#eeeeee;padding-top: 10px;">{{url("api")}}/</span>
                    ...
                    <div class='col-sm-2'>
                        <div class='form-group'>
                            ...
                            <select id='tipe_action' name='action' required class='form-control'>
                ...
                <div class='form-group'>
                    ...
                    <table id='table-parameters' class='table table-striped table-bordered'>
                        ...
                        <tr>
                            ...
                            <th width="10%" title='is Mandatory ?'>Mandatory</th>
                            <th width="10%" title='is used ?'>Enable</th>
                            <th width="5%">-</th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <div class='form-group'>
                    ...
                    <textarea name='condition' rows='3' class='form-control' placeholder="status = [paramStatus]">{{$row->condition}}</textarea>
